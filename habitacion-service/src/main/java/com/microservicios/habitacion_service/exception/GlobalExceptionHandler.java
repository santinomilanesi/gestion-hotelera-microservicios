...
public class GlobalExceptionHandler {
    ...
    // Se dispara cuando, por ejemplo, el precio es negativo o el número está vacío.
    ...
    // 2. Manejar errores cuando no se encuentra una habitación - 404 Not Found
    ...
    public ResponseEntity<ErrorResponse> manejarGlobal(Exception ex, WebRequest request) {
        ErrorResponse error = new ErrorResponse(
            ...
            "Error inesperado en el servicio de habitaciones: " + ex.getMessage(), 
            request.getDescription(false)
        );
